var CanvasParticle = (function(){
	...
	function canvasSize(canvas){
		// 获取特定div的宽高
		var width = document.getElementById("bg").style.width;
		var height = document.getElementById("bg").style.height;
		width = parseInt(width);
		height = parseInt(height);
		canvas.width = width || window.innerWeight || document.documentElement.clientWidth || document.body.clientWidth;
		canvas.height = (height || window.innerWeight || document.documentElement.clientHeight || document.body.clientHeight) / 1.5;
	}
